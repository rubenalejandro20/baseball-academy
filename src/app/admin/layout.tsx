    ...
    <>
      ...
      <div className="flex items-center justify-between px-5 h-16 border-b border-[var(--border)] shrink-0">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <p className="font-display font-bold text-sm tracking-widest text-white leading-none">
              ACADEMY
            </p>
            <p className="text-[10px] text-slate-500 tracking-wide leading-none mt-0.5">
              PERFORMANCE
            </p>
          </div>
        </div>
